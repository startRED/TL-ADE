 ...
 * @param {any} discovery
 * @param {any} repoIr
 * @returns {Array<{ key: string, value: string, ref: string, aliases: string[] }>}
 */
function buildFactIndex(discovery, repoIr) {
  const index = []
  const sources = [
 ...
 *
 * @param {{ unknowns?: any[], discovery?: any, repoIr?: any }} input
 * @returns {Array<{ question: string, kind?: string, evidence: string }>}
 */
export function getRefusedQuestions({ unknowns = [], discovery = {}, repoIr = {} }) {
  const refused = []
 ...
 *
 * @param {{ unknowns?: any[], discovery?: any, repoIr?: any, maxQuestions?: number }} input
 * @returns {Array<{ id: string, unknown_ref: string, kind: string, text: string, options: any[], default_if_unknown?: string }>}
 */
export function buildInterview({ unknowns = [], discovery = {}, repoIr = {}, maxQuestions = 5 }) {
 ...
 * @param {any} question
 * @param {any} answer
 * @returns {{ contract: any, decision: any }}
 */
export function applyInterviewAnswer(contract, question, answer) {
