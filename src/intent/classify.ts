 ...
 */
export async function classifyIntent(input: { request: string; discovery?: any; repoIr?: any }, advisor?: Function): Promise<{ complexity: string; confidence: number; source: string; cost: { model_calls: number; usd: number; model_id?: string }; domains?: string[]; rationale?: string }> {
