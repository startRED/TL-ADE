 ...
 */
export const EXTERNAL_EFFECT_PERMISSION = Object.freeze({
  push: 'push',
 ...
 * }} input
 * @returns {(spec: any, effectFn: any) => Promise<any>}
 */
 ...
 * @param {any} deps
 * @param {{
 *   loaded: import('./plan-load.js').LoadedPlan,
 *   repoDir: string,
 *   missionDir: string,
 * }} input
 * @returns {Promise<{
 ...
 * }>}
 */
export async function runUnattendedBatch(deps, { loaded, repoDir, missionDir }) {
  ...
  /** @type {string[]} */
  const completed = []
  /** @type {Map<string, { reason: string, evidence_path: string }>} */
