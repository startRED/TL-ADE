...
import {
  Play, CheckCircle, Warning, ArrowCounterClockwise, Trash, Flask, GitDiff, ChatCircleText, Terminal,
  ...
  return (
    <div className="shell">
      <header className="topbar">
        ...
        <div className="topright">{m && <MissionChip m={m} />}</div>
      </header>
...
function Report({ m, decide }) {
  ...
  return (
    <div className="rpt">
      ...
      {m.state === 'complete' && <div className="card good"><CheckCircle weight="fill" /><div><b>Pronta</b><p>{m.reason === 'accepted_by_operator' ? 'Aceita por você.' : 'A prova falhou antes, passou depois, e o Codex aprovou.'} As alterações estão em <Code>proto/example</Code>.</p></div></div>}
