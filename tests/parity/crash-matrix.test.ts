...
// cada célula leva ~60 s sozinha; sob a suíte inteira com uma missão ao lado passava dos 120 s (26/09)
describe('crash_matrix', () => {
  test('engine_before_spawn', () => verifyMatrixCell('before_spawn', 'engine'), 240_000)
  test('worker_before_spawn', () => verifyMatrixCell('before_spawn', 'worker'), 240_000)
  test('engine_after_maker_effect', () => verifyMatrixCell('after_maker_effect', 'engine'), 240_000)
  test('worker_after_maker_effect', () => verifyMatrixCell('after_maker_effect', 'worker'), 240_000)
  test('engine_before_contain', () => verifyMatrixCell('before_contain', 'engine'), 240_000)
  test('worker_before_contain', () => verifyMatrixCell('before_contain', 'worker'), 240_000)
  test('engine_after_contain', () => verifyMatrixCell('after_contain', 'engine'), 240_000)
  test('worker_after_contain', () => verifyMatrixCell('after_contain', 'worker'), 240_000)
  test('engine_before_commit', () => verifyMatrixCell('before_commit', 'engine'), 240_000)
  test('worker_before_commit', () => verifyMatrixCell('before_commit', 'worker'), 240_000)
  test('engine_after_commit', () => verifyMatrixCell('after_commit', 'engine'), 240_000)
  test('worker_after_commit', () => verifyMatrixCell('after_commit', 'worker'), 240_000)
})
