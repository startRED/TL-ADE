...
| R12 | Tetos de pack são chute | digest, "Hipóteses assumidas" | corte em bytes: `max_pack_bytes` 120 000 [hipótese], seção de rodada 24 000, skills ≤5k tokens por skill e soma ≤7,5k (E13, E14); telemetria por seção; ajustar por p90 no dogfood [hipótese] |
