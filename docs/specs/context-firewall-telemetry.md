...
| 4 | `skills` | story (≤3 ids) | 7.500/skill, 20.000 total | `ade show skill:<id>` |
...
O teto por skill é 7.500 tokens e a soma do bloco é 20.000 (`architecture.md §11 E14`); o filtro duro
