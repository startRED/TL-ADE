...
**Tetos** (`architecture.md` §11 E14): ≤3 skills por story; **≤10k tokens por skill**; **≤15k somados** (E70)
...
teto por skill para 5k" (**aceito**, `architecture.md` §11 E14, elevado por §12 E70 a ≤10k por skill com soma ≤15k), "usar
...
**D1 → aceita** (`architecture.md` §11 E14). O teto vira **≤10k tokens por skill com soma ≤15k** (E70),
