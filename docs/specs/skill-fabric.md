...
(3) fecho                precedência §6, dedup, teto 3, poda gulosa
                         por score até a soma caber em 20k (E70), journal
```
...
**Tetos** (`architecture.md` §11 E14): ≤3 skills por story; **≤7,5k tokens por skill**; **≤20k somados** (E70)
...
teto por skill para 5k" (**aceito**, `architecture.md` §11 E14, elevado por §12 E70 a ≤7,5k por skill com soma ≤20k), "usar
...
**D1 → aceita** (`architecture.md` §11 E14). O teto vira **≤7,5k tokens por skill com soma ≤20k** (E70),
