...
| [0031](0031-trilhos-paralelos-emenda-0014.md) | Trilhos paralelos em cópias isoladas (emenda o ADR 0014) | Aceito (decisão do plano da v2 aprovado por Erick, 2026-09-23) |
...
| [0033](0033-modelos-pelos-planos-emenda-0005.md) | Modelos escolhidos pelos planos, escada por inteligência e reserva de outra empresa (emenda o ADR 0005) | Aceito (decisão do plano da v3 aprovado por Erick, 2026-09-23) |
| [0034](0034-painel-comanda-pela-api-emenda-0013.md) | Painel comanda pela API, servido do último build que passou (emenda o ADR 0013) | Aceito (decisão do plano da v5 aprovado por Erick, 2026-09-23) |
...
| [0048](0048-maker-confere-rodando-o-app-pela-receita.md) | Com receita no projeto-alvo (`.claude/skills/run-*` ou `verify`), a política do maker pede subir e usar o programa antes de entregar e relatar em `handoff.claims` (`app-run`); o texto da receita vai no pack de toda empresa | Aceito (pedido de Erick, 2026-09-26) |
...
| Intenção, contrato e prova | 0007, 0008, 0016, 0028, 0036, 0048 | §4, §5, §11 E1–E4, E12, E18–E20 |
