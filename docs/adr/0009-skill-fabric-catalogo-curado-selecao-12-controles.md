...
barato fecha **≤3** → bloco fixo do pack ordenado por id estável, com **≤10k tokens por skill e soma
≤25k** (E14, E70). Um braço de controle "BM25@3 puro" é medido antes de manter o seletor barato. O engine
...
| Teto fixo de 2,5k tokens por skill | poda skill legítima antes do BM25; o limite real é ≤10k por skill e ≤25k de soma (E14) |
...
ADR 0008 (skills decididas no `prepare`), ADR 0011 (teto de 25k e `cited`), ADR 0017, ADR 0019.
