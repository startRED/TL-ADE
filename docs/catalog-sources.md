...
| `img2threejs/img2threejs` | Apache-2.0 | `6e60b5e` | skill | **ADAPT**, dormente | Gate de qualidade objetivo antes de aceitar resultado é padrão reaproveitável. Corpo de 8,2k tokens estoura o teto por skill (≤10k, soma ≤25k, §11 E14): só entra se o domínio 3D aparecer e depois de progressive disclosure |
...
tokens. Corpo injetado de ≤3 skills: ~6–7k tokens, dentro da soma ≤25k (§11 E14, §12 E70). O gargalo é o índice, nunca o corpo — é o que
